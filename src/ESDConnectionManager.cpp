...
void DebugPrint(const char *, const char * = nullptr) {
}
...
void ESDConnectionManager::SetSettings(const nlohmann::json &inSettings, const std::string& inContext)
{
	nlohmann::json jsonObject;
...
void ESDConnectionManager::SendToPropertyInspector(const std::string & inAction, const std::string & inContext, const nlohmann::json & inPayload)
{
	nlohmann::json jsonObject;
