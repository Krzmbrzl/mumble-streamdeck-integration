...
#ifndef MUMBLE_STREAMDECK_INTEGRATION_ESDCONNECTIONMANAGER_H_
#define MUMBLE_STREAMDECK_INTEGRATION_ESDCONNECTIONMANAGER_H_
...
public:
	...
	void SendToPropertyInspector(const std::string& inAction, const std::string& inContext, const nlohmann::json &inPayload);
...
#endif // MUMBLE_STREAMDECK_INTEGRATION_ESDCONNECTIONMANAGER_H_
