...
#ifndef MUMBLE_STREAMDECK_INTEGRATION_ESDSDKDEFINES_H_
#define MUMBLE_STREAMDECK_INTEGRATION_ESDSDKDEFINES_H_
...
#endif // MUMBLE_STREAMDECK_INTEGRATION_ESDSDKDEFINES_H_
